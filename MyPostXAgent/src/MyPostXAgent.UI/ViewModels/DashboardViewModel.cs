...
public class DashboardViewModel : BaseViewModel
{
    ...
    public string ActionAIContentDesc { get; set; } = "";
    public string ActionVideoEditor { get; set; } = "";
    public string ActionVideoEditorDesc { get; set; } = "";
    public string ActionAddAccount { get; set; } = "";
    public string ActionAddAccountDesc { get; set; } = "";
    public string ActionImportFlow { get; set; } = "";
    public string ActionImportFlowDesc { get; set; } = "";
    ...
    private void UpdateLanguageDisplay()
    {
        ...
        ActionAIContent = "AI Content";
        ActionAIContentDesc = LocalizationStrings.DashboardPage.AIContentAction(isThai);
        ActionVideoEditor = "Video Editor";
        ActionVideoEditorDesc = LocalizationStrings.DashboardPage.VideoEditorAction(isThai);
        ActionAddAccount = isThai ? "เพิ่มบัญชี" : "Add Account";
        ActionAddAccountDesc = LocalizationStrings.DashboardPage.AddAccountAction(isThai);
        ActionImportFlow = "Import Flow";
        ActionImportFlowDesc = LocalizationStrings.DashboardPage.ImportFlowAction(isThai);
        ...
        ActivityPostsReady = isThai ? "5 โพสต์พร้อมใช้งาน" : "5 posts ready";
        ...
        OnPropertyChanged(nameof(ActionAIContentDesc));
        OnPropertyChanged(nameof(ActionVideoEditor));
        OnPropertyChanged(nameof(ActionVideoEditorDesc));
        OnPropertyChanged(nameof(ActionAddAccount));
        OnPropertyChanged(nameof(ActionAddAccountDesc));
        OnPropertyChanged(nameof(ActionImportFlow));
        OnPropertyChanged(nameof(ActionImportFlowDesc));
